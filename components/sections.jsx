...
function buildTerminalCommands(navigate) {
  ...
  return {
    help: () => [
      ...
      "  zhask             the startup — kaveo platform brief",
    ...
    whoami: () => [
      "guest@rd-0001 — clearance: PUBLIC",
      "subject: Rohith Donthula — Offensive Security & Detection Engineering",
      "also:    Co-Founder, Zhask — architect of kaveo",
    ],
    about: () => [
      "I break systems, build the detections that catch the break, and ship the product that does both.",
      "MS Cybersecurity, Yeshiva University. CompTIA Security+, CySA+, PenTest+.",
      "3+ yrs: banking pentest (Capgemini) -> healthcare purple team (Cerner) -> MSSP SOC (SecVal).",
      "Co-founder of Zhask: kaveo, an AI-native cloud security platform.",
      "Principle: attack what you build, build what survives the attack.",
    ],
    zhask: () => [
      "ZHASK — kaveo :: AI-native cloud security, self-hosted, zero-egress.",
      "  96 deterministic detectors   43 read-only AWS collectors",
      "  0 AI agents in detection     300+ automated tests",
      "  grounded AI: every claim is a (text, citation) pair checked against an",
      "  immutable evidence ledger — uncited claims are dropped before storage.",
      "  native MCP server: read-only, cited access for your own agents.",
      "  thesis: determinism finds the truth. AI has to show its work.",
    ],
    ...
    skills: () => [
      "OFFENSE    Burp Suite · Metasploit · Nmap · BloodHound · Impacket · Responder",
      "           Cobalt Strike · Atomic Red Team · Caldera · OWASP Top 10 / API Top 10",
      "DEFENSE    Splunk SPL · Sigma · ELK · Stellar Cyber XDR · CrowdStrike Falcon",
      "           Snort/Suricata · Cortex XSOAR · NIST 800-61 · EnCase · FTK · Volatility",
      "CLOUD+AI   AWS IAM graph · Pacu · ScoutSuite · Prowler · CSPM engineering",
      "           Okta · SailPoint · CyberArk · MITRE ATLAS · OWASP LLM Top 10 · MCP",
      "FRAMEWORKS MITRE ATT&CK · SOC 2 · PCI-DSS · GDPR · HIPAA · NIST · CIS",
